...
if(!window.CKEDITOR)window.CKEDITOR=(function()
{
    var a=
    {
        timestamp:'C3HA5RM',version:'3.6.3',revision:'7474',rnd:Math.floor(Math.random()*900)+100,_:
        {
        }
...
if(!a.env)a.env=(function()
{
    ...
    {
        ie:/*@cc_on!@*/false,opera:!!c&&c.version,webkit:b.indexOf(' applewebkit/')>-1,air:b.indexOf(' adobeair/')>-1,mac:b.indexOf('macintosh')>-1,quirks:document.compatMode=='BackCompat',mobile:b.indexOf('mobile')>-1,iOS:/(ipad|iphone|ipod)/.test(b),isCustomDomain:function()
        {
...
a.dtd=(function()
{
    var f=e.extend,g=
    {
        isindex:1,fieldset:1
    }
    ,h=
    {
        input:1,button:1,select:1,textarea:1,label:1
    }
    ,i=f(
    {
        a:1
    ...
    ,l=
    {
        ins:1,del:1,script:1,style:1
    }
    ,m=f(
    {
        b:1,acronym:1,bdo:1,'var':1,'#':1,abbr:1,code:1,br:1,i:1,cite:1,kbd:1,u:1,strike:1,s:1,tt:1,strong:1,q:1,samp:1,em:1,dfn:1,span:1,wbr:1
    }
    ,l),n=f(
    {
        sub:1,img:1,object:1,sup:1,basefont:1,map:1,applet:1,font:1,big:1,small:1,mark:1
    }
    ,m),o=f(
    {
        p:1
    ...
    return
    {
        $nonBodyContent:f(B,A,y),$block:C,$blockLimit:
        {
        ...
        ,$empty:
        {
            area:1,base:1,br:1,col:1,hr:1,img:1,input:1,link:1,meta:1,param:1,wbr:1
        }
        ,$listItem:
        {
            dd:1,dt:1,li:1
        ...
        ,$nonEditable:
        {
            applet:1,button:1,embed:1,iframe:1,map:1,object:1,option:1,script:1,textarea:1,param:1,audio:1,video:1
        }
        ,$captionBlock:
        {
            caption:1,legend:1
        ...
        ,$removeEmpty:
        {
            abbr:1,acronym:1,address:1,b:1,bdo:1,big:1,cite:1,code:1,del:1,dfn:1,em:1,font:1,i:1,ins:1,label:1,kbd:1,q:1,s:1,samp:1,small:1,span:1,strike:1,strong:1,sub:1,sup:1,tt:1,u:1,'var':1,mark:1
        }
        ,$tabIndex:
        {
        ...
        ,html:A,head:z,style:t,script:t,body:v,base:
        {
        }
        ,link:
        {
        ...
        ,font:r,ins:r,menu:w,abbr:r,label:r,table:
        {
            thead:1,col:1,tbody:1,tr:1,colgroup:1,caption:1,tfoot:1
        }
        ,code:r,tfoot:s,cite:r,li:v,input:
        {
        }
        ,iframe:v,strong:r,textarea:t,noframes:v,big:r,small:r,span:r,hr:
        {
        }
        ,dt:r,sub:r,optgroup:
        {
        ...
        ,bdo:r,'var':r,div:v,object:u,sup:r,dd:v,strike:r,area:
        {
        }
        ,dir:w,map:f(
        {
...
e.extend(d.window.prototype,
{
    ...
    ,getViewPaneSize:function()
    {
        ...
        return
        {
            width:(h?g.documentElement.clientWidth:g.body.clientWidth)||0,height:(h?g.documentElement.clientHeight:g.body.clientHeight)||0
        };
    }
    ,getScrollPosition:function()
    {
        ...
        {
            x:g.pageXOffset||0,y:g.pageYOffset||0
        };
        else
        {
            var h=g.document;
            return
            {
                x:h.documentElement.scrollLeft||h.body.scrollLeft||0,y:h.documentElement.scrollTop||h.body.scrollTop||0
            };
        }
    }
}
...
e.extend(g.prototype,
{
    appendStyleSheet:function(h)
    {
        ...
        else
        {
            ...
            i.setAttributes(
            {
                rel:'stylesheet',type:'text/css',href:h
            }
            );
...
{
    var m=j.getCustomData('list_marker_id')||j.setCustomData('list_marker_id',e.getNextNumber()).getCustomData('list_marker_id'),n=j.getCustomData('list_marker_names')||j.setCustomData('list_marker_names',
    {
    }
...
h.clearMarkers=function(i,j,k)
{
    ...
    for(var n in l)j.removeCustomData(n);j.removeCustomData('list_marker_names');if(k)
    {
...
if(c&&(b.ie7Compat||b.ie6Compat))return function(j)
{
    ...
    switch(j)
    {
        case 'class':j='className';
        break;
        case 'http-equiv':j='httpEquiv';
        break;
        case 'name':return n.$.name;
        case 'tabindex':var k=i.call(n,j);
        if(k!==0&&n.$.tabIndex===0)k=null;
        return k;
        break;
        case 'checked':var l=n.$.attributes.getNamedItem(j),m=l.specified?l.nodeValue:n.$.checked;
        return m?'checked':null;
        case 'hspace':case 'value':return n.$[j];
        case 'style':return n.$.style.cssText;
    }
    return i.call(n,j);
};
else return i;
...
for(var j=0;j<i.length;j++)
{
    ...
    switch(k.nodeName)
    {
        ...
        default:if(k.specified)return true;
    }
}
return false;
}
...
x=
{
    x:r.x-p(this,'left')-s.x||0,y:r.y-p(this,'top')-s.y||0
};
y=
{
    x:r.x+u+p(this,'right')-(s.x+w)||0,y:r.y+t+p(this,'bottom')-(s.y+v)||0
};
...
switch(i)
{
    case 1:j.addClass('cke_on');
    j.removeClass('cke_off');
    j.removeClass('cke_disabled');
    break;
    case 0:j.addClass('cke_disabled');
    j.removeClass('cke_off');
    j.removeClass('cke_on');
    break;
    default:j.addClass('cke_off');
    j.removeClass('cke_on');
    j.removeClass('cke_disabled');
    break;
}
...
(function()
{
    var i=
    {
        width:['border-left-width','border-right-width','padding-left','padding-right'],height:['border-top-width','border-bottom-width','padding-top','padding-bottom']
    };
function j(k)
{
    var l=0;
...
var m=this.loaded,n=this.registered,o=[],p=
{
}
,q=
{
...
{
var n=this.get(k),o=n.langEntries||(n.langEntries=
{
}
),p=n.lang||(n.lang=[]);
...
this._.items[l]=
{
    type:m,command:n.command||null,args:Array.prototype.slice.call(arguments,2)
};
}
,create:function(l)
{
    ...
    ,s=function(x)
    {
        ...
        j.load(z.split(','),function(D)
        {
            ...
            a.scriptLoader.load(G,function()
            {
                ...
                for(var N=0;N<M.length;N++)for(var O=0;
                O<E.length;
                O++)
                {
                    var P=E[O];
...
s._=
{
isBlockLike:q,hasInlineStarted:r||!q
};
};
...
|$)/g,function(o,p,q)
{
p=='font-family'&&(q=q.replace(/["']/g,''));n[p.toLowerCase()]=q;});return{rules:n,populate:function(o){var p=this.toString();if(p)o instanceof h?o.setAttribute('style',p):o instanceof a.htmlParser.element?o.attributes.style=p:o.style=p;
}
,'toString':function()
{
var o=[];
...
(function()
{
    a.htmlParser.filter=e.createClass(
    {
        $:function(q)
        {
            this._=
            {
                elementNames:[],attributeNames:[],elements:
                {
                    $length:0
                }
                ,attributes:
...
(function()
{
    var l=
    {
        address:1,blockquote:1,dl:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1,li:1,dt:1,dd:1,legend:1,caption:1
    }
    ,m=
    {
        body:1,div:1,table:1,tbody:1,tr:1,td:1,th:1,form:1,fieldset:1
    }
    ,n=function(o)
    {
        var p=o.getChildren();
...
var n=
{
    block:1,'list-item':1,table:1,'table-row-group':1,'table-header-group':1,'table-footer-group':1,'table-row':1,'table-column-group':1,'table-column':1,'table-cell':1,'table-caption':1
};
...
d.range.prototype=
{
    ...
    ,createBookmark:function(u)
    {
        ...
        return
        {
            startNode:u?x+'S':v,endNode:u?x+'E':w,serializable:u,collapsed:z
        };
    }
    ,createBookmark2:function(u)
    {
        ...
        return
        {
            start:v.getAddress(u),end:z?null:w.getAddress(u),startOffset:x,endOffset:y,normalized:u,collapsed:z,is2:true
        };
    }
    ...
    ,enlarge:function(u,v)
    {
        switch(u)
        {
            case 1:if(this.collapsed)return;
    ...
    ,setStartAt:function(u,v)
    {
        ...
        switch(v)
        {
            case 1:w.setStart(u,0);
            break;
            case 2:if(u.type==3)w.setStart(u,u.getLength());
            else w.setStart(u,u.getChildCount());
            break;
            case 3:w.setStartBefore(u);
            break;
            case 4:w.setStartAfter(u);
        }
        l(w);
    }
    ,setEndAt:function(u,v)
    {
        ...
        switch(v)
        {
            case 1:w.setEnd(u,0);
            break;
            case 2:if(u.type==3)w.setEnd(u,u.getLength());
            else w.setEnd(u,u.getChildCount());
            break;
            case 3:w.setEndBefore(u);
            break;
            case 4:w.setEndAfter(u);
        }
        l(w);
    }
    ...
    ,splitBlock:function(u)
    {
        ...
        return
        {
            previousBlock:z,nextBlock:A,wasStartOfBlock:C,wasEndOfBlock:D,elementPath:B
        };
    }
...
a.skins.add('kama',(function()
{
    ...
    return
    {
        ...
        ,margins:[0,0,0,0],init:function(n)
        {
...
requires:['dialog'],init:function(m)
{
    ...
    {
        label:m.lang.about.title,command:'about'
    }
    );
...
(function()
{
    ...
    j.add(m,
    {
        availableLangs:
        {
            cs:1,cy:1,da:1,de:1,el:1,en:1,eo:1,fa:1,fi:1,fr:1,gu:1,he:1,it:1,mk:1,nb:1,nl:1,no:1,tr:1,ug:1,vi:1,'zh-cn':1
        }
        ,init:function(o)
        {
            var p=this;
...
return function(C)
{
    ...
    if(F&&F.length)
    {
        ...
        ,H=D.createBookmarks(),I=F.createIterator(),J,K=0;
...
j.add('bidi',
{
requires:['styles','button'],init:function(B)
{
    ...
    B.on('contentDom',function()
    {
        B.document.on('dirChanged',function(E)
        {
            B.fire('dirChanged',
            {
                node:E.data,dir:E.data.getDirection(1)
            }
            );
        }
        );
...
j.add('blockquote',
{
    init:function(q)
    {
        ...
        {
            label:q.lang.blockquote,command:'blockquote'
        }
        );
...
(function()
{
    k.button.prototype=
    {
        render:function(m,n)
        {
            ...
            var t=
            {
                id:p,button:this,editor:m,focus:function()
                {
...
(function()
{
    ...
    var p=
    {
        canUndo:false,exec:c?function(y)
        {
            y.focus();
...
function s(y,z,A)
{
    ...
    F.setStyles(
    {
        position:'absolute',top:D.getStartElement().getDocumentPosition().y+'px',width:'1px',height:'1px',overflow:'hidden'
    }
    );
...
j.add('clipboard',
{
    requires:['dialog','htmldataprocessor'],init:function(y)
    {
...
function z(A,B,C,D)
{
    ...
    {
        label:E,command:B,group:'clipboard',order:D
    }
    );
};
...
if(y.contextMenu)y.contextMenu.addListener(function(A,B)
{
    ...
    return
    {
        cut:!C&&v('Cut',y),copy:v('Copy',y),paste:!C&&(b.webkit?2:v('Paste',y))
    };
}
);
}
...
function q(t,u,v)
{
    ...
    {
        label:v,title:v,className:'cke_button_'+t.toLowerCase(),modes:
        {
            wysiwyg:1
        }
        ,panel:
        {
            css:m.skin.editor.css,attributes:
            {
                role:'listbox','aria-label':o.panelTitle
            }
        }
...
j.contextMenu=e.createClass(
{
    base:a.menu,$:function(m)
    {
        this.base.call(this,m,
        {
            panel:
            {
                className:m.skinClass+' cke_contextmenu',attributes:
                {
...
j.add('dialogadvtab',
{
    createAdvancedTab:function(o,p)
    {
        ...
        {
            id:'advanced',label:q.advancedTab,title:q.advancedTab,elements:[
            {
        ...
        if(p.id||p.dir)
        {
            if(p.id)s.push(
            {
                id:'advId',att:'id',type:'text',label:q.id,setup:m,commit:n
            }
            );
            if(p.dir)s.push(
            {
                id:'advLangDir',att:'dir',type:'select',label:q.langDir,'default':'',style:'width:100%',items:[[q.notSet,''],[q.langDirLTR,'ltr'],[q.langDirRTL,'rtl']],setup:m,commit:n
            }
            );
            r.elements[0].children.push(
            {
                type:'hbox',widths:['50%','50%'],children:[].concat(s)
            }
            );
        }
        if(p.styles||p.classes)
        {
            ...
            if(p.styles)s.push(
            {
                id:'advStyles',att:'style',type:'text',label:q.styles,'default':'',validate:a.dialog.validate.inlineStyle(q.invalidInlineStyle),onChange:function()
                {
                }
                ...
                {
                    var v=this.getValue();
                    if(v)v=v.replace(new RegExp('\\s*'+t+'s*:[^;]*(?:$|;s*)','i'),'').replace(/^[;
                    \s]+/,'').replace(/\s+$/,'');
                    if(u)
                    {
                        v&&!/;
...
{
label:n.toolbar,command:'creatediv'
}
);
if(m.addMenuItems)
{
...
editdiv:
{
    label:n.edit,command:'editdiv',group:'div',order:1
}
,removediv:
{
    label:n.remove,command:'removediv',group:'div',order:5
}
}
);
...
(function()
{
    var m=
    {
        toolbarFocus:
        {
            editorFocus:false,readOnly:1,exec:function(o)
            {
...
var u=e.addFunction(t),v=e.addFunction(function(x,y)
{
    ...
    {
        case B?39:37:case 9:A=a.document.getById(z+(x+1));
    ...
    j.add('enterkey',
    {
        requires:['keystrokes','indent'],init:function(t)
        {
            t.addCommand('enter',
            {
                ...
                ,editorFocus:false,exec:function(v)
                {
                    r(v);
                }
            }
...
function q(r,s)
{
    ...
    ,u=[],v=
    {
        nbsp:'\xa0',shy:'­',gt:'>',lt:'<',amp:'&',apos:"'",quot:'"'
    };
...
function m(v,w)
{
    var x=[];
    if(!w)return v;
    else for(var y in w)x.push(y+'='+encodeURIComponent(w[y]));return v+(v.indexOf('?')!=-1?'&':'?')+x.join('&');
};
function n(v)
{
    v+='';
...
function r(v,w,x,y)
{
    ...
    for(var B in y)
    {
        ...
        if(typeof z.filebrowser=='string')
        {
            var C=
            {
                action:z.type=='fileButton'?'QuickUpload':'Browse',target:z.filebrowser
            };
            z.filebrowser=C;
        }
...
init:function(m)
{
    ...
    m.ui.addButton('Find',
    {
        label:m.lang.findAndReplace.find,command:'find'
    }
    );
    ...
    {
        label:m.lang.findAndReplace.replace,command:'replace'
    }
    );
...
j.add('flash',
{
    init:function(p)
    {
        ...
        {
            label:p.lang.common.flash,command:'flash'
        }
        );
        ...
        if(p.addMenuItems)p.addMenuItems(
        {
            flash:
            {
                label:p.lang.flash.properties,command:'flash',group:'flash'
            }
        }
        );
...
e.extend(i,
{
flashEmbedTagOnly:false,flashAddEmbedTag:true,flashConvertOnEdit:false
}
);
(function()
{
function m(n,o,p,q,r,s,t)
{
    ...
    n.ui.addRichCombo(o,
    {
        label:q.label,title:q.panelTitle,className:'cke_'+(p=='size'?'fontSize':'font'),panel:
        {
            css:n.skin.editor.css.concat(u.contentsCss),multiSelect:false,attributes:
            {
...
requires:['richcombo','styles'],init:function(m)
{
    ...
    {
        label:o.label,title:o.panelTitle,className:'cke_format',panel:
        {
            css:m.skin.editor.css.concat(n.contentsCss),multiSelect:false,attributes:
            {
...
m.ui.addButton(q,
{
label:n.common[q.charAt(0).toLowerCase()+q.slice(1)],command:r
}
);
a.dialog.add(r,s);
}
...
form:
{
label:n.form.menu,command:'form',group:'form'
}
,checkbox:
{
label:n.checkboxAndRadio.checkboxTitle,command:'checkbox',group:'checkbox'
}
,radio:
{
label:n.checkboxAndRadio.radioTitle,command:'radio',group:'radio'
}
,textfield:
{
label:n.textfield.title,command:'textfield',group:'textfield'
}
,hiddenfield:
{
label:n.hidden.title,command:'hiddenfield',group:'hiddenfield'
}
,imagebutton:
{
label:n.image.titleButton,command:'imagebutton',group:'imagebutton'
}
,button:
{
label:n.button.title,command:'button',group:'button'
}
,select:
{
label:n.select.title,command:'select',group:'select'
}
,textarea:
{
...
m.contextMenu.addListener(function(q)
{
    if(q&&!q.isReadOnly())
    {
        ...
        {
            case 'button':case 'submit':case 'reset':return
            {
                button:2
            };
...
{
    case 'button':case 'submit':case 'reset':q.data.dialog='button';
    break;
...
return function(n)
{
    ...
    {
        case 'class':return q.$.className.length>0;
...
(function()
{
    ...
    j.add(n,
    {
        init:function(o)
        {
            ...
            {
                label:o.lang.horizontalrule,command:n
            }
            );
        }
    }
...
var s=f,t=['caption','colgroup','col','thead','tfoot','tbody'],u=e.extend(
{
}
...
function A(T)
{
    ...
    {
        case 'true':U.contenteditable='true';
        break;
        case '1':delete U.contenteditable;
        break;
    }
};
for(v in
...
function S(T,U)
{
    ...
    (\d*?)-->/g,Z=[/<script[\s\S]*?<\/script>/gi,/<noscript[\s\S]*?<\/noscript>/gi].concat(W);
...
(function()
{
    j.add('iframe',
    {
        requires:['dialog','fakeobjects'],init:function(m)
        {
            ...
            if(m.addMenuItems)m.addMenuItems(
            {
                iframe:
                {
                    label:o.title,command:'iframe',group:'image'
                }
            }
            );
...
(function()
{
    j.add('image',
    {
        init:function(o)
        {
            ...
            {
                label:o.lang.common.image,command:p
            }
            );
            ...
            if(o.addMenuItems)o.addMenuItems(
            {
                image:
                {
                    label:o.lang.image.menu,command:'image',group:'image'
                }
            }
            );
...
{
    label:t.lang.indent,command:'indent'
}
);
t.ui.addButton('Outdent',
{
    label:t.lang.outdent,command:'outdent'
}
);
...
j.add('justify',
{
    init:function(q)
    {
        ...
        {
            label:q.lang.justify.left,command:'justifyleft'
        }
        );
        q.ui.addButton('JustifyCenter',
        {
            label:q.lang.justify.center,command:'justifycenter'
        }
        );
        q.ui.addButton('JustifyRight',
        {
            label:q.lang.justify.right,command:'justifyright'
        }
        );
        q.ui.addButton('JustifyBlock',
        {
            label:q.lang.justify.block,command:'justifyblock'
        }
        );
...
j.add('link',
{
    init:function(m)
    {
        ...
        m.ui.addButton('Link',
        {
            label:m.lang.link.toolbar,command:'link'
        }
        );
        m.ui.addButton('Unlink',
        {
            label:m.lang.unlink,command:'unlink'
        }
        );
        m.ui.addButton('Anchor',
        {
            label:m.lang.anchor.toolbar,command:'anchor'
        }
        );
        ...
        if(m.addMenuItems)m.addMenuItems(
        {
            anchor:
            {
                label:m.lang.anchor.menu,command:'anchor',group:'anchor',order:1
            }
            ,removeAnchor:
            {
                label:m.lang.anchor.remove,command:'removeAnchor',group:'anchor',order:5
            }
            ,link:
            {
                label:m.lang.link.menu,command:'link',group:'link',order:1
            }
            ,unlink:
            {
                label:m.lang.unlink,command:'unlink',group:'link',order:5
            }
        }
        );
if(m.contextMenu)m.contextMenu.addListener(function(p,q)
...
e.extend(i,
{
linkShowAdvancedTab:true,linkShowTargetTab:true
}
);
(function()
{
...
j.list=
{
    listToArray:function(L,M,N,O,P)
    {
        ...
        for(var Q=0,R=L.getChildCount();Q<R;Q++)
        {
            ...
            var T=
            {
                parent:L,indent:O,element:S,contents:[]
            };
            if(!P)
            {
            ...
            else if(aa.indent==-1&&!N&&aa.grandparent)
            {
                ...
                for(Q=0;Q<aj;Q++)
                {
                    ...
                    if(ai.type==1&&ai.isBlockBoundary())
                    {
                        ...
                        ah&&ai.setAttribute('style',ah.replace(/([^;
                        ])$/,'$1;')+(ai.getAttribute('style')||''));
                        ag&&ai.addClass(ag);
                    }
                    else if(ad||ae||ah||ag)
                    {
...
y.prototype=
{
    exec:function(L)
    {
        ...
        var T=O.createBookmarks(true),U=[],V=
        {
        }
        ,W=P.createIterator(),X=0;
...
j.add('list',
{
    init:function(L)
    {
        ...
        {
            label:L.lang.numberedlist,command:'numberedlist'
        }
        );
        L.ui.addButton('BulletedList',
        {
            label:L.lang.bulletedlist,command:'bulletedlist'
        }
        );
        ...
        requires:['dialog'],init:function(m)
        {
            ...
            if(m.addMenuItems)
            {
                ...
                m.addMenuItems(
                {
                    numberedlist:
                    {
                        label:m.lang.list.numberedTitle,group:'list',command:'numberedListStyle'
                    }
                    ,bulletedlist:
                    {
                        label:m.lang.list.bulletedTitle,group:'list',command:'bulletedListStyle'
                    }
                }
                );
            }
...
s.addCommand('maximize',
{
    ...
    ,readOnly:1,editorFocus:false,exec:function()
    {
        ...
        if(this.state==2)
        {
            ...
            var H=
            {
                overflow:b.webkit?'':'hidden',width:0,height:0
            };
...
C.setStyles(
{
    'z-index':s.config.baseFloatZIndex-1,left:'0px',top:'0px'
}
);
z=r(C);
...
{
label:t.maximize,command:'maximize'
}
);
s.on('mode',function()
{
...
{
label:m.lang.newPage,command:'newpage'
}
);
}
}
...
{
label:m.lang.pagebreak,command:'pagebreak'
}
);
var n=['{','background: url('+a.getUrl(this.path+'images/pagebreak.gif')+') no-repeat center center;','clear: both;','width:100%; _width:99.9%;','border-top: #999999 1px dotted;','border-bottom: #999999 1px dotted;','padding:0;','height: 5px;','cursor: default;','}'].join('').replace(/;
/g,' !important;');
...
{
label:n.lang.pastefromword.toolbar,command:'pastefromword'
}
);
...
(function()
{
    var m=
    {
        ...
        ,canUndo:false,readOnly:1,exec:function(o)
        {
...
{
label:o.lang.preview,command:n
}
);
}
}
...
,canUndo:false,readOnly:1,modes:
{
wysiwyg:!b.opera
}
};
...
{
label:m.lang.removeFormat,command:'removeFormat'
}
);
m._.removeFormat=
{
...
var w=e.addFunction(function(x)
{
    ...
    r=
    {
        width:p.$.offsetWidth||0,height:p.$.offsetHeight||0
    };
    q=
    {
        x:x.screenX,y:x.screenY
    };
...
if(window.scayt==undefined)
{
    ...
    a.document.getHead().append(a.document.createElement('script',
    {
        attributes:
        {
            type:'text/javascript',async:'true',src:w
        }
    }
    ));
}
...
t.addMenuItem(w,
{
label:v,command:w,group:y,order:z
}
);
}
,s=
...
B.scaytToggle=
{
    label:C.enable,command:m,group:A
};
if(z[0]==1)B.scaytOptions=
{
    label:C.options,group:A,onClick:function()
    {
        n='options';
        t.openDialog(m);
    }
...
{
    label:C.langs,group:A,onClick:function()
    {
        n='langs';
        t.openDialog(m);
    }
...
{
    label:C.dictionariesTab,group:A,onClick:function()
    {
        n='dictionaries';
        t.openDialog(m);
    }
...
B.scaytAbout=
{
    label:t.lang.scayt.about,group:A,onClick:function()
    {
        n='about';
        t.openDialog(m);
    }
...
{
    label:C.title,title:b.opera?C.opera_title:C.title,className:'cke_button_scayt',modes:
    {
        wysiwyg:1
    }
    ,onRender:function()
    ...
    ,onMenu:function()
    {
        ...
        return
        {
            scaytToggle:2,scaytOptions:E&&F[0]?2:0,scaytLangs:E&&F[1]?2:0,scaytDict:E&&F[2]?2:0,scaytAbout:E&&F[3]?2:0
        };
    }
}
);
...
{
label:m.lang.smiley.toolbar,command:'smiley'
}
);
...
(function()
{
    ...
    {
        readOnly:1,preserveState:true,editorFocus:false,exec:function(r)
        {
            this.toggleState();
            this.refresh(r);
        }
    ...
    j.add('showblocks',
    {
        requires:['wysiwygarea'],init:function(r)
        {
            ...
            {
                label:r.lang.showBlocks,command:'showblocks'
            }
            );
            r.on('mode',function()
            {
...
(function()
{
    ...
    var p=
    {
        preserveState:true,editorFocus:false,readOnly:1,exec:function(q)
        {
            this.toggleState();
            this.refresh(q);
        }
            ...
            if(t)t.addRules(
            {
                elements:
                {
                    table:function(u)
                    {
                        ...
                        w&&(v['class']=w.replace(m,'').replace(/\s
                        {
                            2
                        }
                        /,' ').replace(/^\s+|\s+$/,''));
...
p.setAttributes(
{
    dir:'ltr',tabIndex:b.webkit?-1:m.tabIndex,role:'textbox','aria-label':m.lang.editorTitle.replace('%1',m.name)
}
);
...
var t=
{
    width:b.ie7Compat?'99%':'100%',height:'100%',resize:'none',outline:'none','text-align':'left'
};
if(c)
{
    q=function()
...
{
label:m.lang.source,command:'source'
}
);
m.on('mode',function()
{
...
,editorFocus:false,readOnly:1,exec:function(m)
{
...
(function()
{
    j.add('stylescombo',
    {
        requires:['richcombo','styles'],init:function(n)
        {
            var o=n.config,p=n.lang.stylesCombo,q=
            {
            }
            ,r=[],s;
function t(u)
...
{
label:p.label,title:p.panelTitle,className:'cke_styles',panel:
{
    css:n.skin.editor.css.concat(o.contentsCss),multiSelect:true,attributes:
    {
...
init:function(m)
{
    ...
    if(m.addMenuItems)m.addMenuItems(
    {
        table:
        {
            label:o.menu,command:'tableProperties',group:'table',order:5
        }
        ,tabledelete:
        {
            label:o.deleteTable,command:'tableDelete',group:'table',order:1
        }
    }
    );
    m.on('doubleclick',function(p)
...
var F=
{
    thead:1,tbody:1,tfoot:1,td:1,tr:1,th:1
};
j.tabletools=
{
    init:function(G)
        ...
        if(G.addMenuItems)G.addMenuItems(
        {
            tablecell:
            {
                label:H.cell.menu,group:'tablecell',order:1,getItems:function()
                {
                    ...
                    return
                    {
                        tablecell_insertBefore:2,tablecell_insertAfter:2,tablecell_delete:2,tablecell_merge:C(I,null,true)?2:0,tablecell_merge_right:C(I,'right',true)?2:0,tablecell_merge_down:C(I,'down',true)?2:0,tablecell_split_vertical:D(I,true)?2:0,tablecell_split_horizontal:E(I,true)?2:0,tablecell_properties:J.length>0?2:0
                    };
                }
            }
            ,tablecell_insertBefore:
            {
                label:H.cell.insertBefore,group:'tablecell',command:'cellInsertBefore',order:5
            }
            ,tablecell_insertAfter:
            {
                label:H.cell.insertAfter,group:'tablecell',command:'cellInsertAfter',order:10
            }
            ,tablecell_delete:
            {
                label:H.cell.deleteCell,group:'tablecell',command:'cellDelete',order:15
            }
            ,tablecell_merge:
            {
                label:H.cell.merge,group:'tablecell',command:'cellMerge',order:16
            }
            ,tablecell_merge_right:
            {
                label:H.cell.mergeRight,group:'tablecell',command:'cellMergeRight',order:17
            }
            ,tablecell_merge_down:
            {
                label:H.cell.mergeDown,group:'tablecell',command:'cellMergeDown',order:18
            }
            ,tablecell_split_horizontal:
            {
                label:H.cell.splitHorizontal,group:'tablecell',command:'cellHorizontalSplit',order:19
            }
            ,tablecell_split_vertical:
            {
                label:H.cell.splitVertical,group:'tablecell',command:'cellVerticalSplit',order:20
            }
            ,tablecell_properties:
            {
                label:H.cell.title,group:'tablecellproperties',command:'cellProperties',order:21
            }
            ,tablerow:
            {
                label:H.row.menu,group:'tablerow',order:1,getItems:function()
                {
                    return
                    {
                        tablerow_insertBefore:2,tablerow_insertAfter:2,tablerow_delete:2
                    };
                }
            }
            ,tablerow_insertBefore:
            {
                label:H.row.insertBefore,group:'tablerow',command:'rowInsertBefore',order:5
            }
            ,tablerow_insertAfter:
            {
                label:H.row.insertAfter,group:'tablerow',command:'rowInsertAfter',order:10
            }
            ,tablerow_delete:
            {
                label:H.row.deleteRow,group:'tablerow',command:'rowDelete',order:15
            }
            ,tablecolumn:
            {
                label:H.column.menu,group:'tablecolumn',order:1,getItems:function()
                {
                    return
                    {
                        tablecolumn_insertBefore:2,tablecolumn_insertAfter:2,tablecolumn_delete:2
                    };
                }
            }
            ,tablecolumn_insertBefore:
            {
                label:H.column.insertBefore,group:'tablecolumn',command:'columnInsertBefore',order:5
            }
            ,tablecolumn_insertAfter:
            {
                label:H.column.insertAfter,group:'tablecolumn',command:'columnInsertAfter',order:10
            }
            ,tablecolumn_delete:
            {
                label:H.column.deleteColumn,group:'tablecolumn',command:'columnDelete',order:15
            }
        }
        );
if(G.contextMenu)G.contextMenu.addListener(function(I,J)
{
    ...
    while(I)
    {
        ...
        {
            tablecell:2,tablerow:2,tablecolumn:2
        };
        I=I.getParent();
    }
    return null;
...
availableLangs:
{
cs:1,cy:1,de:1,en:1,eo:1,et:1,fa:1,fi:1,fr:1,hr:1,it:1,nb:1,nl:1,no:1,tr:1,ug:1,'zh-cn':1
}
,init:function(m)
{
...
{
label:m.lang.specialChar.toolbar,command:n
}
);
}
}
...
function p(q)
{
    return
    {
        editorFocus:false,canUndo:false,modes:
        {
            wysiwyg:1
        }
        ,exec:function(r)
...
(function()
{
    j.add('templates',
    {
        requires:['dialog'],init:function(o)
        {
            ...
            {
                label:o.lang.templates.button,command:'templates'
            }
            );
        }
    }
...
(function()
{
    ...
    {
        for(var o=0,p;p=this.toolbars[o++];)for(var q=0,r;
        r=p.items[q++];
        )
        {
            if(r.focus)
...
switch(s)
{
case 9:case 2228224+9:while(!u||!u.items.length)
{
...
s.ui.addButton('Undo',
{
    label:s.lang.undo,command:'undo'
}
);
s.ui.addButton('Redo',
{
    label:s.lang.redo,command:'redo'
}
);
...
(function()
{
    var m=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;
    |\u00A0|&#160;
    )?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,n=d.walker.whitespaces(true);
function o(C)
{
...
function x(C)
{
    return C.type==3&&e.trim(C.getText()).match(/^(?:&nbsp;
    |\xa0)$/);
};
function y(C)
{
...
j.add('wysiwygarea',
{
    requires:['editingblock'],init:function(C)
    {
...
if(ah&&af.getHtml().match(/^<p>&nbsp;
<\/p>$/i)&&ah.startContainer.equals(af))setTimeout(function()
{
...
requires:['dialog'],init:function(m)
{
    ...
    {
        label:m.lang.spellCheck.toolbar,command:n
    }
    );
...
{
    var U=a.dialog._.dialogDefinitions[T],V=e.clone(u),W=S.config.dialog_buttonsOrder||'OS',X=S.lang.dir,Y=
    {
    }
    ,Z,aa;
    ...
    this._=
    {
        editor:S,element:ac.element,name:T,contentSize:
        {
            width:0,height:0
        }
        ,size:
        ...
        ,tabIdList:[],currentTabId:null,currentTabIndex:null,pageCount:0,lastTab:null,tabBarMode:false,focusList:[],currentFocusIndex:0,hasFocus:false
    };
    this.parts=ac.parts;
e.setTimeout(function()
{
...
var ad=
{
    position:b.ie6Compat?'absolute':'fixed',top:0,visibility:'hidden'
};
...
if(S._.removeDialogTabs&&(Y=S._.removeDialogTabs[T]))for(Z=0;
Z<Y.length;
Z++)U.removeContents(Y[Z]);
...
{
type:'hbox',className:'cke_dialog_footer_buttons',widths:[],children:U.buttons
}
,ap).getChild();
...
return function(S,T)
{
    ...
    {
        dialog:U,skin:U._.editor.skinName,width:S,height:T
    }
    ,U._.editor);
    U.fire('resize',
    {
        skin:U._.editor.skinName,width:S,height:T
    }
    ,U._.editor);
...
return
{
    width:S.$.offsetWidth||0,height:S.$.offsetHeight||0
};
}
,move:(function()
{
...
{
    page:S,currentPage:this._.currentTabId
}
)===true)return;
...
,okButton:(function()
{
    var S=function(T,U)
    {
        ...
        return e.extend(
        {
            id:'ok',type:'button',label:T.lang.common.ok,'class':'cke_dialog_ui_button_ok',onClick:function(V)
            {
                var W=V.data.dialog;
                if(W.fire('ok',
                {
...
)(),cancelButton:(function()
{
    var S=function(T,U)
    {
        ...
        return e.extend(
        {
            id:'cancel',type:'button',label:T.lang.common.cancel,'class':'cke_dialog_ui_button_cancel',onClick:function(V)
            {
                var W=V.data.dialog;
                if(W.fire('cancel',
                {
...
,currentTop:null,currentZIndex:null
};
a.event.implementOn(a.dialog);
a.event.implementOn(a.dialog.prototype,true);
var u=
{
resizable:3,minWidth:600,minHeight:400,buttons:[a.dialog.okButton,a.dialog.cancelButton]
}
,v=function(S,T,U)
{
...
S.parts.title.on('mousedown',function(ab)
{
    T=
    {
        x:ab.data.$.screenX,y:ab.data.$.screenY
    };
...
function G(S)
{
    ...
    var ad=function()
    {
        ...
        Z.setStyles(
        {
            width:ag.width+'px',height:ag.height+'px'
        }
        );
    }
    ,ae=function()
...
,M=function(S,T,U,V,W)
{
    ...
    X.push(
    {
        uiElement:S,dialog:T,key:U,keyup:W||S.accessKeyUp,keydown:V||S.accessKeyDown
    }
    );
}
,N=function(S)
...
(function()
{
    k.dialog=
    {
        uiElement:function(S,T,U,V,W,X,Y)
        {
            ...
            var Z=(V.call?V(T):V)||'div',aa=['<',Z,' '],ab=(W&&W.call?W(T):W)||
            {
            }
            ,ac=(X&&X.call?X(T):X)||
            {
            }
            ,ad=(Y&&Y.call?Y.call(this,S,T):Y)||'',ae=this.domId=ac.id||e.getNextId()+'_uiElement',af=this.id=T.id,ag;
            ac.id=ae;
            var ah=
            {
            };
            ...
            var aj=[];
            for(ag in ah)aj.push(ag);ac['class']=aj.join(' ');if(T.title)ac.title=T.title;
            ...
            for(ag in ac)aa.push(ag+'="'+e.htmlEncode(ac[ag])+'" ');aa.push('>',ad,'</',Z,'>');U.push(aa.join(''));
            (this._||(this._=
            {
            }
            )).dialog=S;
...
var X=this._.children=T,Y=W&&W.widths||null,Z=W&&W.height||null,aa=
{
}
,ab,ac=function()
{
...
(function()
{
    var m=
    {
        address:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1,section:1,header:1,footer:1,nav:1,article:1,aside:1,figure:1,dialog:1,hgroup:1,time:1,meter:1,menu:1,command:1,keygen:1,output:1,progress:1,details:1,datagrid:1,datalist:1
    }
    ,n=
    {
        a:1,embed:1,hr:1,img:1,li:1,object:1,ol:1,table:1,td:1,tr:1,th:1,ul:1,dl:1,dt:1,dd:1,form:1,audio:1,video:1
    }
    ,o=/\s*(?:;
    \s*|$)/,p=/#\((.+?)\)/g,q=d.walker.bookmark(0,1),r=d.walker.whitespaces(1);
    ...
    a.style.prototype=
    {
        ...
        ,checkActive:function(T)
        {
            ...
            switch(Y.type)
            {
                case 1:return Y.checkElementRemovable(T.block||T.blockLimit,true);
...
function t(T)
{
    ...
    while(af)
    {
        ...
        if(aj&&ag&&!ag.collapsed)
        {
            ...
            for(av in au.attrs)ar.removeAttribute(av);for(aw in au.styles)ar.removeStyle(aw);if(as&&!ar.hasAttributes())ar=null;if(ar)
            {
...
k.panelButton=e.createClass(
{
    ...
    ,proto:
    {
        createPanel:function(n)
        {
            ...
            ,q=this._.panelDefinition.block,r=p.parent||a.document.getBody(),s=this._.panel=new k.floatPanel(n,r,p),t=s.addBlock(o.id,q),u=this;
            s.onShow=function()
            {
...
k.floatPanel=e.createClass(
{
    $:function(p,q,r,s)
    {
        ...
        this._=
        {
            editor:p,panel:u,parentElement:q,definition:r,document:t,iframe:w,children:[],dir:p.lang.dir
        };
        p.on('mode',function()
        {
            this.hide();
...
beforeInit:function(m)
{
var n=m.config.menu_groups.split(','),o=m._.menuGroups=
{
}
,p=m._.menuItems=
{
...
(function()
{
    a.menu=e.createClass(
    {
        $:function(n,o)
        {
            ...
            ,o.panel,
            {
                css:n.skin.editor.css,level:r._.level-1,block:
                {
                }
            }
...
$:function(n,o,p)
{
    ...
    e.extend(q,p,
    {
        order:0,className:'cke_button_'+o
    }
    );
...
,readOnly:c||b.webkit,exec:function(z)
{
    switch(z.mode)
    {
        case 'wysiwyg':z.document.$.execCommand('SelectAll',false,null);
        z.forceNextSelectionCheck();
        z.selectionChange();
        break;
        case 'source':var A=z.textarea.$;
...
switch(O)
{
    case 13:case 33:case 34:case 35:case 36:case 37:case 39:case 8:case 45:case 46:w(z.document);
}
}
,null,null,10);
}
...
{
label:z.lang.selectAll,command:'selectAll'
}
);
z.selectionChange=p;
...
var y=
{
img:1,hr:1,li:1,table:1,tr:1,td:1,th:1,embed:1,object:1,ol:1,ul:1,a:1,input:1,form:1,select:1,textarea:1,button:1,fieldset:1,thead:1,tfoot:1
};
...
var B=function(C,D)
{
    ...
    while(K<=L)
    {
        ...
        else if(b.ie9Compat&&H.tagName=='BR')
        {
            ...
            return
            {
                container:Q[D?'anchorNode':'focusNode'],offset:Q[D?'anchorOffset':'focusOffset']
            };
        }
        else return
        {
            container:E,offset:A(H)
        };
    }
    ...
    else
    {
        ...
        if(!O)return
        {
            container:E,offset:A(H)+(N>0?0:1)
        };
        while(O>0)try
        {
        ...
        return
        {
            container:P,offset:N>0?-O:P.nodeValue.length+O
        };
    }
};
return function()
...
switch(G.getType())
{
    case 3:return G.getSelectedElement();
    case 2:var C=G.getRanges()[0];
    if(C)
    {
        if(!C.collapsed)
        {
...
j.add('fakeobjects',
{
    requires:['htmlwriter'],afterInit:function(r)
    {
...
a.editor.prototype.createFakeElement=function(r,s,t,u)
{
    ...
    {
        'class':s,src:a.getUrl('images/spacer.gif'),'data-cke-realelement':encodeURIComponent(r.getOuterHtml()),'data-cke-real-node-type':r.type,alt:w,title:w,align:r.getAttribute('align')||''
    };
...
a.editor.prototype.createFakeParserElement=function(r,s,t,u)
{
    ...
    var z=
    {
        'class':s,src:a.getUrl('images/spacer.gif'),'data-cke-realelement':encodeURIComponent(x),'data-cke-real-node-type':r.type,alt:w,title:w,align:r.attributes.align||''
    };
...
$:function(m)
{
    ...
    n.block=
    {
        multiSelect:n.multiSelect,attributes:n.attributes
    };
    o._=
    {
        panelDefinition:n,items:
        {
        }
        ,state:2
    };
...
var t=e.addFunction(function(v,w)
{
    ...
    switch(x)
    {
        case 13:case 32:case 40:e.callFunction(q,w);
        break;
        default:r.onkey(r,x);
    }
    v.preventDefault();
...
if(typeof n=='string')
{
    this.forceSimpleAmpersand&&(n=n.replace(/&amp;
    /g,'&'));
    ...
    var m=function(n)
    {
        ...
        if(!p)
        {
            p=o.menu=new a.menu(n,
            {
                panel:
                {
                    className:n.skinClass+' cke_contextmenu',attributes:
                    {
...
(function()
{
    ...
    e.extend(k.dialog,
    {
        labeledElement:function(u,v,w,x)
        {
            ...
            var z=this._.children=[],A=function()
            {
                ...
                else
                {
                    var D=
                    {
                        type:'hbox',widths:v.widths,padding:0,children:[
                        {
        ...
        ,textInput:function(u,v,w)
        {
            ...
            {
                'class':'cke_dialog_ui_input_'+v.type,id:x,type:v.type
            }
            ,z;
...
for(var E in y)D.push(E+'="'+y[E]+'" ');D.push(' /></div>');return D.join('');
};
...
for(var C in z)B.push(C+'="'+e.htmlEncode(z[C])+'" ');B.push('>',e.htmlEncode(x._['default']),'</textarea></div>');return B.join('');
};
...
{
'class':'cke_dialog_ui_checkbox_input',type:'checkbox','aria-labelledby':B
};
t(z);
...
var A=[],B=[],C=
{
'class':'cke_dialog_ui_radio_item','aria-labelledby':this._.labelId
}
...
,true),M=
{
type:'radio','class':'cke_dialog_ui_radio_input',name:D,value:H,'aria-labelledby':J
}
,N=[];
...
,true),A=[],B=[],C=
{
    id:x.inputId,'class':'cke_dialog_ui_input_select','aria-labelledby':this._.labelId
};
if(v.size!=undefined)C.size=v.size;
if(v.multiple!=undefined)C.multiple=v.multiple;
t(z);
for(var D=0,E;D<v.items.length&&(E=v.items[D]);D++)B.push('<option value="',e.htmlEncode(E[1]!==undefined?E[1]:E[0]).replace(/"/g,'&quot;'),'" /> ',e.htmlEncode(E[0]));if(typeof z.inputStyle!='undefined')z.style=z.inputStyle;x.select=new k.dialog.uiElement(u,z,A,'select',null,C,B.join(''));
return A.join('');
};
...
attributes:
{
tabIndex:-1,'class':'cke_panel_block',role:'presentation'
}
,styles:
{
display:'none'
...
switch(n)
{
case 'next':var o=r._.focusIndex,p=r.element.getElementsByTag('a'),q;
while(q=p.getItem(++o))
{
...
return
{
    ...
    ,buildDialog:function(o)
    {
        ...
        return
        {
            element:q,parts:
            {
                dialog:q.getChild(0),title:s,close:t,tabs:r.getChild(2),contents:r.getChild([3,0,0,0]),footer:r.getChild([3,0,1,0])
            }
        };
    }
    ,destroy:function(o)
