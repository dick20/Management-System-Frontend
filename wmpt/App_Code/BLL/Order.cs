...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.Order dal=new Maticsoft.DAL.Order();
		public Order()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Order> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.Order> modelList = new List<Maticsoft.Model.Order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.Order model;
