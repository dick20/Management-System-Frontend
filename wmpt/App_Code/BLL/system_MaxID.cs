...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.system_MaxID dal=new Maticsoft.DAL.system_MaxID();
		public system_MaxID()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.system_MaxID> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.system_MaxID> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.system_MaxID> modelList = new List<Maticsoft.Model.system_MaxID>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.system_MaxID model;
