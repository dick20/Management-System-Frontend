...
namespace Maticsoft.DAL
{
	...
	public partial class Manager2
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("seller_id", "Manager2"); 
		}
		...
		public bool Exists(int seller_id,int order_id)
		{
			...
			strSql.Append("select count(1) from Manager2");
			strSql.Append(" where seller_id=@seller_id and order_id=@order_id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Manager2(");
			strSql.Append("seller_id,order_id)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Manager2 set ");
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public bool Delete(int seller_id,int order_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Manager2 ");
			strSql.Append(" where seller_id=@seller_id and order_id=@order_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@seller_id", SqlDbType.Int,4),
					new SqlParameter("@order_id", SqlDbType.Int,4)			};
		...
		public Maticsoft.Model.Manager2 GetModel(int seller_id,int order_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 seller_id,order_id from Manager2 ");
			strSql.Append(" where seller_id=@seller_id and order_id=@order_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@seller_id", SqlDbType.Int,4),
					new SqlParameter("@order_id", SqlDbType.Int,4)			};
			...
			Maticsoft.Model.Manager2 model=new Maticsoft.Model.Manager2();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Manager2 DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Manager2 model=new Maticsoft.Model.Manager2();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select seller_id,order_id ");
			strSql.Append(" FROM Manager2 ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Manager2 T ");
