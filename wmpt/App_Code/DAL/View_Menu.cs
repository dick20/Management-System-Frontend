...
namespace Maticsoft.DAL
{
	...
	public partial class View_Menu
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.View_Menu model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_Menu(");
			strSql.Append("seller_id,seller_name,seller_pwd,role_id,seller_addr,seller_phone,seller_idcard,food_id,food_name,food_type,food_price,food_desc,food_img)");
			...
			parameters[7].Value = model.food_id;
			parameters[8].Value = model.food_name;
			parameters[9].Value = model.food_type;
			parameters[10].Value = model.food_price;
			parameters[11].Value = model.food_desc;
			parameters[12].Value = model.food_img;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.View_Menu model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_Menu set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_Menu ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.View_Menu GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 seller_id,seller_name,seller_pwd,role_id,seller_addr,seller_phone,seller_idcard,food_id,food_name,food_type,food_price,food_desc,food_img from View_Menu ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Maticsoft.Model.View_Menu model=new Maticsoft.Model.View_Menu();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.View_Menu DataRowToModel(DataRow row)
		{
			Maticsoft.Model.View_Menu model=new Maticsoft.Model.View_Menu();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select seller_id,seller_name,seller_pwd,role_id,seller_addr,seller_phone,seller_idcard,food_id,food_name,food_type,food_price,food_desc,food_img ");
			strSql.Append(" FROM View_Menu ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_Menu ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_Menu T ");
